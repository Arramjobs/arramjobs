                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="row g-3 needs-validation" novalidate action="<?php echo baseUrl . "providerController/viewDashboard" ?>" onsubmit="return validateForm()" method="post" >
                                    ...
                                    <br>
                                        <div class="form-check">
                                                <p>Create an account ? <a href="<?php echo baseUrl . "providerController/registration" ?>">Register</a></p>
                                        </div>
                                    </div>
