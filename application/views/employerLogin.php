                                ...
                                <div class="card-body">
                                    ...
                                    <form class="row g-3 needs-validation" novalidate
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="input-group has-validation">
                                                ...
                                                <input type="number" name="mobilenumber" class="form-control"
                                                    id="userID" oninput="validatePhoneNumber(this)"
                                                    onkeyup="checkMobileNumber()" required
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="input-group has-validation">
                                                <input type="password" name="erpassword" class="form-control"
                                    ...
                                    <div class="col-12">
                                        ...
                                        <p style="color: black; font-size: small;">If you have any doubts, Please
                                            contact us : <span style="color: #0F52BA;"><a href="tel:7418334443"
                                                    ...
                                                    onmouseover="this.style.color='#668722'"
                                                    onmouseout="this.style.color='blue'"><b>+91
                                                        7418334443</b></a></span></p>
                                    </div>
                                </div>
                            </div>
                        </div>
