...
/* Display uploaded file */
      ...
      .cer10upload , .cer12upload ,  .cerugupload ,  .cerpgupload ,  .cerdocupload{
        ...
        #file-input-label ,  #file-input-label12 ,  #file-input-labelug ,  #file-input-labelpg ,  #file-input-labeldoc ,  #file-input-labelaf ,   #file-input-labelab  ,   #file-input-labelpp {
            font-weight: 200;
            border: 1px solid #ccc;
            border-radius: 2px;
            padding: 6px 12px;
          ...
          ?>
              <div class="form-step form-step-active">
                ...
                <p class="seekerdashboardcontent my-5 mx-md-5 px-5">At Arram Job Portal, our unwavering commitment is to empower individuals to realize their utmost potential. Regardless of where you stand in your career journey—whether you're
                 ...
                 <div class=" notecontent mx-md-5 px-5" style="text-align: justify;"> <p ><b>Note : </b>The following documents are required :</p>
               <ul>
