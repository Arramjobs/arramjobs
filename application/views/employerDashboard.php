...
<body>
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                        ...
                        <li>
                            <a class="dropdown-item d-flex align-items-center"
                                ...
                                href="<?php echo baseUrl . "Employer/logout" ?>">
            ...
            <section class="Multi Columns Form">
                ...
                <div class="d-flex justify-content-between mb-3">
                    ...
                    <a href="<?php echo baseUrl . "Employer/jobViewTable" ?>"> <button type="button" class="btn btn-info">
                            Next <i class="bi bi-arrow-right pe-2"></i></button></a>
                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="uploadedfile" style="display:flex;">
                                        ...
                                        <a class="ps-2 pt-2" href="<?php echo $value['company_logourl']; ?>" target="_blank"
                                            id="existfile"><?php echo $value['company_logo']; ?></a>
                                    </div>
            ...
            <div class="card" id="addjobs" style="display:none">
                <div class="card-body">
                    ...
                    <form class="row g-3 needs-validation" novalidate name="experienceform" method="post"
                        onsubmit="return validateForm()" action="<?php echo baseUrl . "Employer/insertJob" ?>">

                        <div class="col-12">
                            <label class="form-label" for="company_name">Company Name</label>
                            <input type="text" class="form-control" id="company_name" name="company_name"
                                value="<?php echo $_SESSION['jobProviderUsername'] ?>" readonly>
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-control" id="category" name="category" onchange="showHideOtherField()"
                                ...
                                foreach ($categoryList as $key => $value) {
                                    ?>
                                    <option value="<?php echo $value->categoryName ?>"><?php echo $value->categoryName ?>
                                    </option>
                                <?php } ?>
            ...
            <section class="Multi Columns Form">
                                    ...
                                    foreach ($this->data['providerJobs'] as $key => $value) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="d-flex">
                                                ...
                                                <a class="px-1 "
                                                    href="<?php echo baseUrl . "Employer/updateAddNew" ?>/<?php echo $value['id'] ?>"><button
                ...
                <div class="card" id="updatejob">
                    <div class="card-body">
                        ...
                        <form class="row g-3 needs-validation" novalidate name="experienceform" method="post"
                            onsubmit="return validateFormUpdate()" action="<?php echo baseUrl . "Employer/updateInsert" ?>">
                            <?php
                    ...
                    <div class="card recent-sales overflow-auto">
                        <div class="card-body">
                            ...
                            if (isset($this->data['response'][0]['name'])) {
                                ...
                                <table class="table mt-4" id="matched">
                                    <thead>
                                        <tr>
                                            <th scope="col">S.No</th>
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <b>
                                            <p style="color:#4BBCF0">Category : <?php echo $this->data['category'] ?></p>
                                        </b>
                                        <b>
                                            <p style="color:#E72868">Count : <?php echo $count - 1; ?></p>
                                        </b>
                                    </div>
                                </table>
                            ...
                            <div class="row">
                                ...
                                <div class="d-flex justify-content-between" id="printdiv">
                                    ...
                                    <form action="<?php echo baseUrl . "employer/requestCandidate" ?>" method="post">
                                        <input class="form-check-input" type="text" name="employer_id" id=""
                                            value="<?php echo $_SESSION['employerid'] ?>" hidden>
                                        <input class="form-check-input" type="text" name="candidateid" id=""
                                            value="<?php echo $this->data['basicDetails'][0]['id']; ?>" hidden>
                                        <input class="form-check-input" type="text" name="requestadmin" id="" value="1"
                                            hidden>

                                        <button type="submit" id="candidaterequest" class="btn btn-success printhide"
                                            onclick="return confirm('Are you sure to send request to view complete details?')">Request
                                            to view complete details</button>
                                    </form>
                                    <button id="candidaterequested" class="btn btn-success printhide" style="display:none"
                                        disabled>Requested to view complete details</button>
                                </div>
                                ...
                                foreach ($this->data['basicDetails'] as $nkey => $nvalue) {
                                    ...
                                    <h2 class="h2 text-secondary p-2 text-uppercase text-center pb-3">
                                        <?php echo $nvalue['name']; ?>
                                    </h2>
                                    <p class="text-center flex-row-reverse pb-3">Candidate ID : <?php echo $nvalue['eeid'] ?>
                                    </p>
                                    <?php
                                    foreach ($this->data['canReqStatus'] as $key => $value) {
                                        if (isset($value['request_status']) && ($value['request_status'] == '3' || $value['request_status'] == '4')) {
                                            ...
                                            <div class="d-sm-flex justify-content-between py-4 resumephoto">
                                                <img src="<?php echo baseUrl . "uploads/" . $nvalue['photo_filename'] ?>" class=""
                                                    width="160" height="160" alt="profile photo">
                                                <?php
                                        }
                                        if (isset($value['request_status']) && ($value['request_status'] == '3' || $value['request_status'] == '4')) { ?>
                                    ...
                                    <div>
                                        ...
                                        if (isset($skills[0]['id']) && !empty($skills)) { ?>
                                            ...
                                            foreach ($this->data['skills'] as $skey => $svalue) {
                                                ?>
                                                <b>
                                                    <h5><?php echo $loopcount; ?>. <?php echo $svalue['skill'] ?> skills : </h5>
                                                </b>
    ...
    <footer id="footer" class="footer">
        <div class="contact">
            <p style="padding-left:38%; color:#blue;">Need help? Contact us anytime: <a
