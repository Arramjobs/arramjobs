...
<body>
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse justify-content-end" id="navbarNav">
				...
				<a class="nav-link" href="#" style="color: white; padding-right: 40px;">Home</a>
					...
					<li class="nav-item">
						<a class="nav-link" href="#employer" style="color: white; padding-right: 40px;">Employer</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="#employee" style="color: white; padding-right: 40px;">Employee</a>
					</li>
					<li class="nav-item">
	...
	<section id="employee" class="about section-padding" style="background-color: #f7fee7">
		<div class="container">
			<div class="row">
				<div class="col-lg-4 col-md-12 col-12">
					<div class="about-img">
	...
	<section id="employer" class="about section-padding" style="background-color: #ede9fe">
		<div class="container">
			<div class="row">
				<div class="col-lg-8 col-md-12 col-12 ps-lg-5 mt-md-2 justify-content-center" style="text-align: justify; font-size: medium;">
					<div class="about-text">
