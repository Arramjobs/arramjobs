    ...
    if ($this->data['method'] == "dashboard") {
        ...
        foreach ($this->data['providerDetail'] as $key => $value) {
            ?>
                            ...
                            <input type="text" class="form-control" value='<?php echo $value['company_name']; ?>' id="name" name="name" placeholder="Enter company name" onkeypress="return allowOnlyLetters(event, this)">
                            <p id="nameerr" style="color: red;"></p>
                            </div>
                            <div class="mb-3 mt-4  mx-sm-5 w-55 ">
                            <label for="phno" class="form-label">Number:</label>
                            <input type="number" class="form-control" value='<?php echo $value['company_mobile_number']; ?>' id="phno" name="phno" placeholder="Enter company phone number">
            <p id="pherr" style="color: red;"></p>
                            </div>
                            <div class="mb-3 mt-4 mx-sm-5 w-55 ">
                            <label for="email" class="form-label">Email-ID:</label>
                            <input type="email" class="form-control" value='<?php echo $value['company_email']; ?>' id="email" name="email" placeholder="Enter company Email-Id">
                            <p id="mailerr" style="color: red;"></p>
                            </div>
                            <div class="mb-3 mt-4  mx-sm-5 w-55 ">
                            <label for="addr" class="form-label">Street Address:</label>
                            <input type="address" class="form-control" value='<?php echo $value['street_address']; ?>' id="addr" name="addr" placeholder="Enter company address">
                            <p id="adderr" style="color: red;"></p>
                            </div>
                            <div class="mb-3 mt-4  mx-sm-5 w-55 ">
                            <label for="addr" class="form-label">Landmark:</label>
                            <input type="address" class="form-control" value='<?php echo $value['Landmark']; ?>' id="landmark1" name="landmark1" placeholder="Enter company landmark">
                            <p id="landerr1" style="color: red;"></p>
                            </div>
                            <div class="mb-3 mt-4  mx-sm-5 w-55 ">
                            <label for="addr" class="form-label">City:</label>
                            <input type="address" class="form-control" value='<?php echo $value['City']; ?>' id="city1" name="city1" placeholder="Enter company city">
                            <p id="cityerr1" style="color: red;"></p>
                            </div>
                            <div class="mb-3 mt-4  mx-sm-5 w-55 ">
                            <label for="addr" class="form-label">State:</label>
                            <input type="address" class="form-control" value='<?php echo $value['state']; ?>' id="state1" name="state1" placeholder="Enter company state">
                            <p id="stateerr1" style="color: red;"></p>
                            </div>
                            <div class="mb-3 mt-4  mx-sm-5 w-55 ">
                            <label for="addr" class="form-label">District:</label>
                            <input type="address" class="form-control" value='<?php echo $value['district']; ?>' id="district1" name="district1" placeholder="Enter company district">
                            <p id="diserr1" style="color: red;"></p>
                            </div>
                            <div class="mb-3 mt-4  mx-sm-5 w-55 ">
                            <label for="addr" class="form-label">Pincode:</label>
                            <input type="number" class="form-control" value='<?php echo $value['pincode']; ?>' id="pincode1" name="pincode1" placeholder="Enter company pincode">
            <p id="pinerr1" style="color: red;"></p>
                            ...
                            <input type="text" class="form-control" value='<?php echo $value['name']; ?>' id="name1" name="name1" placeholder="Enter contact person name" onkeypress="return allowOnlyLetters1(event, this)">
                            <p id="nameerr1" style="color: red;"></p>
                            </div>
                            <div class="mb-3 mt-4  mx-sm-5 w-55 ">
                            <label for="role" class="form-label">Role:</label>
                            <input type="text" class="form-control" value='<?php echo $value['role']; ?>' id="role" name="role" placeholder="Enter contact person role">
                            <p id="rolerr" style="color: red;"></p>
                            </div>
                            <div class="mb-3 mt-4  mx-sm-5 w-55 ">
                            <label for="phno1" class="form-label">Mobile Number:</label>
                            <input type="number" class="form-control" value='<?php echo $value['mobile_number']; ?>' id="phno1" name="phno1" placeholder="Enter contact person number">
                            <p id="pherr1" style="color: red;"></p>
                            </div>
                            <div class="mb-3 mt-4  mx-sm-5 w-55 ">
                            <label for="mail1" class="form-label">Email-ID:</label>
                            <input type="email" class="form-control" value='<?php echo $value['email']; ?>' id="mail1" name="mail1" placeholder="Enter contact person Email-ID">
