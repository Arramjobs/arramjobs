                        ...
                        <div class="col-lg-5 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="card mb-3">
                                <div class="card-body">
                                    ...
                                    <form class="row g-3 needs-validation" novalidate id="h" onsubmit="return group()"
                                        enctype="multipart/form-data" name="forms"
                                        action="<?php echo baseUrl . "Employer/employerRegistration" ?>" method="post">
                                        ...
                                        <div class="">
                                            <label for="addr" class="form-label">City <span class="text-danger">*</span>
                                            </label>
                                        ...
                                        <div class="">
                                            ...
                                            <p style="color:grey;textalign:center;font-size:small;margin-top:20px">PNG,
                                                JPG, JPEG, PDF Maximum size: 1024KB</p>
                                        </div>
                                        <div class="">
                                        ...
                                        <div class="">
                                            <label for="name1" class="form-label">Name <span
                                                    class="text-danger">*</span></label>
                                        ...
                                        <div class="">
                                            <label for="phno1" class="form-label">Mobile Number <span
                                                    class="text-danger">*</span></label>
                        ...
                        <div class="invalid-feedback">You must agree before submitting.</div>
                                        ...
                                        <div class="col-12">
                                            <p class="small mb-0">Already have an account? <a
                                                    href="<?php echo baseUrl . "Employer/login" ?>">Login</a></p>
                                        </div>
                                    </form>
