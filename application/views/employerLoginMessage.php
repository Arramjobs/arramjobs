    ...
    <main>
        ...
        <section>
                <div class="my-5 py-md-5 text-center">                                            
                    <p style=" font-size: 30px;"><b>WELCOME TO <a href="<?php echo baseUrl; ?>"><span style="color:  #7aa12b;">ARRAM JOBS</span></a> !</b></p>
                        <p style="color: black;">Please wait for admin approval to log in. <span style="color: #0F52BA;">Try again later. </span></p><br>
                        <p style="color: black; font-size: 14px;">For any queries or doubts, please reach out to us for prompt assistance. <span style="color: #0F52BA;"><b><a href="tel:7418334443" style="color:#0F52BA ; text-decoration: none; font-size:14px"
